...
const COLUMNS: TableColumn[] = [
  ...
  { field: 'needDate', header: "Need Date", sortable: true, filterType: 'datepicker', html: (row: Record<string, unknown>) => row.needDate ? new Date(String(row.needDate)).toLocaleDateString() : '—' },
  ...
  { field: 'status', header: "Status", sortable: true, filterType: 'radio', filterOptions: [{ label: "Draft", value: "0" }, { label: "PendingManagerApproval", value: "1" }, { label: "PendingFinanceApproval", value: "2" }, { label: "PendingDirectorApproval", value: "3" }, { label: "Approved", value: "4" }, { label: "Ordered", value: "5" }], html: (row: Record<string, unknown>) => { const m: Record<string, string> = {["0"]: "Draft", ["1"]: "PendingManagerApproval", ["2"]: "PendingFinanceApproval", ["3"]: "PendingDirectorApproval", ["4"]: "Approved", ["5"]: "Ordered"}; return m[String(row.status ?? '')] ?? String(row.status ?? '\u2014'); } },
