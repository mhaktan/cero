...
namespace cero.Tests.PurchaseOrders
{
    public class PurchaseOrderAppServiceTests
    {
        ...
        public void Repository_GetAll_ShouldReturnQueryable()
        {
            ...
            var entities = new[]
            {
                new PurchaseOrder { Id = 1, OrderNo = "Test orderNo", OrderDate = DateTime.UtcNow, OrderAmount = 10.0m },
                new PurchaseOrder { Id = 2, OrderNo = "Test orderNo", OrderDate = DateTime.UtcNow, OrderAmount = 10.0m },
            }.AsQueryable();
        ...
        public async Task Create_ShouldInsertEntity()
        {
            ...
            {
                OrderNo = "Test orderNo", OrderDate = DateTime.UtcNow, OrderAmount = 10.0m
            };

            _repositoryMock.Setup(r => r.InsertAndGetIdAsync(It.IsAny<PurchaseOrder>()))
                .ReturnsAsync(1);
            _repositoryMock.Setup(r => r.GetAsync(It.IsAny<long>()))
                .ReturnsAsync(new PurchaseOrder { Id = 1, OrderNo = "Test orderNo", OrderDate = DateTime.UtcNow, OrderAmount = 10.0m });
