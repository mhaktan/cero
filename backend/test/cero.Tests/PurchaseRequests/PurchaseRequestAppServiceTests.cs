...
namespace cero.Tests.PurchaseRequests
{
    public class PurchaseRequestAppServiceTests
    {
        ...
        public void Repository_GetAll_ShouldReturnQueryable()
        {
            ...
            var entities = new[]
            {
                new PurchaseRequest { Id = 1, RequestNo = "Test requestNo", Justification = "Test justification", NeedDate = DateTime.UtcNow, Status = 0 },
                new PurchaseRequest { Id = 2, RequestNo = "Test requestNo", Justification = "Test justification", NeedDate = DateTime.UtcNow, Status = 0 },
            }.AsQueryable();
        ...
        public async Task Create_ShouldInsertEntity()
        {
            ...
            {
                RequestNo = "Test requestNo", Justification = "Test justification", NeedDate = DateTime.UtcNow, Status = 0
            };

            _repositoryMock.Setup(r => r.InsertAndGetIdAsync(It.IsAny<PurchaseRequest>()))
                .ReturnsAsync(1);
            _repositoryMock.Setup(r => r.GetAsync(It.IsAny<long>()))
                .ReturnsAsync(new PurchaseRequest { Id = 1, RequestNo = "Test requestNo", Justification = "Test justification", NeedDate = DateTime.UtcNow, Status = 0 });
