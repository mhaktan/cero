...
namespace cero.Web.Host
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new OpenApiInfo { Title = "cero API", Version = "v1" });
            ...
            return services.AddAbp<ceroWebHostModule>();
        }
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "cero API V1");
            });
