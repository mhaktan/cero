...
namespace cero.EntityFrameworkCore
{
    [DependsOn(typeof(ceroCoreModule), typeof(AbpEntityFrameworkCoreModule))]
    public class ceroEntityFrameworkCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            Configuration.Modules.AbpEfCore().AddDbContext<ceroDbContext>(options =>
            {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(ceroEntityFrameworkCoreModule).GetAssembly());
        }
    }
}
