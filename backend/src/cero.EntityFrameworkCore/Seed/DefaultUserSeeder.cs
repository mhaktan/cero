...
namespace cero.EntityFrameworkCore.Seed
{
    /// <summary>
    ...
    public class DefaultUserSeeder
    {
        ...
        public void Seed()
        {
            ...
            try
            {
                ...
                {
                    customRole_0 = new AppRole { Name = "Requester", DisplayName = "Talep Eden", Description = "Satın alma talebi oluşturur, kalem ekler; teklif girişine herkes yetkili olduğundan teklif de ekleyebilir. Kendi taleplerini takip eder.", IsSystem = false, IsActive = true };
                ...
                var customPerms_0 = new string[] { "PurchaseRequest.Create", "PurchaseRequest.Read", "PurchaseRequest.Update", "PurchaseRequestItem.Read", "PurchaseRequestItem.Create", "PurchaseRequestItem.Update", "PurchaseRequestItem.Delete", "PurchaseRequestItem.ChangeStatus", "Quotation.Read", "Quotation.Create", "Quotation.Update", "Quotation.Delete", "Quotation.ChangeStatus" };
                ...
                {
                    customRole_1 = new AppRole { Name = "DepartmentManager", DisplayName = "Birim Müdürü", Description = "Tüm talepleri inceler, birim müdürü onay adımında onayla/reddet kararı verir. Teklif de girebilir.", IsSystem = false, IsActive = true };
                ...
                var customPerms_1 = new string[] { "PurchaseRequest.Read", "PurchaseRequest.ChangeStatus", "PurchaseRequestItem.Read", "Quotation.Read", "Quotation.Create", "Quotation.Update", "Quotation.Delete", "Quotation.ChangeStatus" };
                ...
                {
                    customRole_2 = new AppRole { Name = "FinanceApprover", DisplayName = "Finans Onaycısı", Description = "Finans onay adımında tüm talepleri inceler, tutar bazlı nihai finansal onayı verir. Teklif de girebilir.", IsSystem = false, IsActive = true };
                ...
                var customPerms_2 = new string[] { "PurchaseRequest.Read", "PurchaseRequest.ChangeStatus", "PurchaseRequestItem.Read", "Quotation.Read", "Quotation.Create", "Quotation.Update", "Quotation.Delete", "Quotation.ChangeStatus", "Department.Read", "ExpenseCategory.Read" };
                ...
                {
                    customRole_3 = new AppRole { Name = "PurchasingOfficer", DisplayName = "Satın Alma Sorumlusu", Description = "Onaylanan talepleri siparişe dönüştürür, tedarikçi ve sipariş yönetimini yürütür. Teklif de girebilir.", IsSystem = false, IsActive = true };
