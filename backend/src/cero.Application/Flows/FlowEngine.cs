                ...
                switch (node.Type)
                {
                    ...
                    case "approval":
                        ...
                        try
                        {
                            ...
                            var appServiceType = System.Type.GetType("cero.Approvals.IApprovalAppService, cero.Application")
                                ?? throw new InvalidOperationException("IApprovalAppService type not found in cero.Application assembly");
                            ...
                            var submitInputType = System.Type.GetType("cero.Approvals.Dto.SubmitApprovalInput, cero.Application")!;
