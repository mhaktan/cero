...
namespace cero.Authorization
{
    public class ceroAuthorizationProvider : AuthorizationProvider
    {
        ...
        {
            return new LocalizableString(name, ceroConsts.LocalizationSourceName);
        }
    }
}
